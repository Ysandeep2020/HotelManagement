...
public class RoomTypeServiceImpl implements RoomTypeService {
	...
	@Override
	public String add(RoomTypeModel request) throws Exception {
...
//	}
	...
	@Override
	public RoomTypeModel findById(int id) throws Exception {
	...
	@Override
	public List<RoomTypeModel> fetchAll() {
		List<RoomTypeModel> models = new ArrayList<>();
